...
class ArmJointDemo:
    JointMap = {'base_joint': {"idx": 0, 'bias': 90, 'range': [-90, 90], 'init': 0},
                ...
                'finger_joint1': {"idx": 5, 'bias': 90, 'range': [-0.015, 0], 'init': 0},
                'finger_joint2': {"idx": 5, 'bias': 90, 'range': [0, 0.015], 'init': 0}
                }
    ...
    def random_joints(self):
        ...
        joints = [-1.5707898017477895, 1.4835300543121201, 0.5985157391139779, -1.5707900315489107, -0.1842700468006928, -0.015000010048018207, 0.0036284922156615746]
        return joints
