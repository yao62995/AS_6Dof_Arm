...
class Pick_Place:
    def __init__(self):
        ...
        self._pose_place = self._arm.get_random_pose()
        # self._pose_place = Pose()
        #
        # self._pose_place.position.x = self._pose_coke_can.position.x - 0.1
        ...
        if not self._grasps_ac.wait_for_server(rospy.Duration(10.0)):
        ...
        if not self._pickup_ac.wait_for_server(rospy.Duration(10.0)):
        ...
        if not self._place_ac.wait_for_server(rospy.Duration(10.0)):
